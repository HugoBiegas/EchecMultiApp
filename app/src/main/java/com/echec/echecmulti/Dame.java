...
public class Dame {
    public ArrayList<String> deplacementDameHost(String[] Echiquier, int coordoner, String[] color) {
        ...
        int ecartF = coordoner + 7,dup=0;
        //les diagonals
        for (int i=0;i<8;i++){
            if (ecartF<64 && ecartF>0){
                for (int j=0;j<15;j++){
                    if (border[j] == ecartF){
                        if (Echiquier[ecartF].equals(""))
                            deplacement.add("D:"+ecartF);
                        else if (color[ecartF].equals("N")){
                            deplacement.add("A:"+ecartF);
                        }
                        dup=1;
                    }
                }
